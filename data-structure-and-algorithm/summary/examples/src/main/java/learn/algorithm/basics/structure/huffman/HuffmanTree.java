package learn.algorithm.basics.structure.huffman;
...
public class HuffmanTree {
     ...
     * 根据哈夫曼编码表，还原成原始字符串
     */
    static String huffmanDecode(String huffmanEncode, Map<Character, String> huffmanForm) {
     ...
     */
    private static TrieNode createTrie(Map<Character, String> huffmanForm) {
