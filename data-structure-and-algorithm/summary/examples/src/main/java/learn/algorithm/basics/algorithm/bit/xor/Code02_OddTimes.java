 ...
 */
public class Code02_OddTimes {

    /**
     * 一个数组中，有一种数出现了奇数次，其余数均出现偶数次，找出这个数并打印。
     * 将数组中的数做异或运算，根据异或运算的性质，出现偶数次的数异或结果为 0 ，奇数次异或结果为本身。
     */
    ...
    /**
     * 一个数组中，有两种数出现了奇数次，其余数均出现偶数次，找出这两种数并打印。
     ...
     * a 和 b 一定分别存在这两大类中，再对其中一类的数做异或运算就能得到 a 或 b。
     */
